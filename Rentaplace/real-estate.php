...
<html>
<head>
<title>RentAPlace | Real-estate</title>
		...
		<div class="container">
			<div class="select-box">
				<div class="select-city-for-local-ads ads-list">
					<label>Select your town to see local ads</label>
						<select name="town" id="town">
							<optgroup label="Popular Cities">
								<option selected style="display:none;color:#eee;">Entire Uniport</option>
								<option>Alakahia</option>
								<option>Aluu</option>
								<option>Choba</option>
							</optgroup>
						</select>
				...
				echo "
					<ul class='list'>
						<a href='single.php?single_id=$rows[id]'>
							<li>
								<img src='php/uploads/$rows[Photos]' title='' alt='' style='width:250px; height:200px'/>
